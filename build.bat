...
:: Tool files
set TOOL_FILES=tools/bezier_tool.c tools/crayon_tool.c tools/drawing_primitives.c tools/fill_tool.c tools/freehand_tools.c tools/highlighter_tool.c tools/magnifier_tool.c tools/pen_tool.c tools/pick_tool.c tools/polygon_tool.c tools/selection.c tools/shape_tools.c tools/shape_session.c tools/stroke_session.c tools/text_session.c tools/tool_session.c tools/text.c
