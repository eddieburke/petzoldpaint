...
typedef enum ToolSessionKind { TOOL_SESSION_NONE = 0, TOOL_SESSION_SELECTION, TOOL_SESSION_TEXT, TOOL_SESSION_SHAPE, TOOL_SESSION_POLYGON, TOOL_SESSION_BEZIER } ToolSessionKind;
